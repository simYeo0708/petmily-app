...
import com.petmily.backend.api.walker.dto.walking.WalkingTrackResponse;
...
public class WalkingWebSocketController {
     ...
     */
    public void broadcastLocationUpdate(Long bookingId, WalkingTrackResponse locationData){
