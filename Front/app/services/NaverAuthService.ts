...
const NaverAuthService = {
   ...
   */
  async loginWithNaver(): Promise<NaverAuthResponse | null> {
    try {
      // ngrok URL 사용 (개발 환경)
      // 프로덕션에서는 실제 도메인 사용
      ...
      console.log('🔐 Naver OAuth - Backend URL:', backendUrl);
      console.log('🔐 Naver OAuth - OAuth URL:', oauthUrl);
      ...
      console.log('🔐 Naver OAuth - Result type:', result.type);
      console.log('🔐 Naver OAuth - Result URL:', result.url);
