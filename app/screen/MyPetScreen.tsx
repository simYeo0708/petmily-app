...
const MyPetScreen = () => {
  ...
  const speciesOptions = [
    { key: "dog", label: "강아지", icon: "@dog.png" },
    { key: "cat", label: "고양이", icon: "@cat.png" },
    { key: "other", label: "기타", icon: "@paw.png" },
  ];
  ...
  return (
    <View style={[myPetScreenStyles.root, { backgroundColor: '#FFFFFF' }]}>
      <StatusBar 
        backgroundColor="#fff" 
            ...
            <View style={myPetScreenStyles.speciesContainer}>
              {speciesOptions.map((option) => (
                <TouchableOpacity
                  ...
                  <Image
                    source={
                      option.icon === '@dog.png' ? require('../../assets/images/dog.png') :
                      option.icon === '@cat.png' ? require('../../assets/images/cat.png') :
