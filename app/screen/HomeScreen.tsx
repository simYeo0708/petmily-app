      ...
      return [
        {
          ...
          type: 'category',
          title: '강아지 사료',
          description: '건강한 강아지 사료를 찾아보세요',
          icon: '🍖',
          action: () => navigation.navigate('Shop', { category: '강아지 사료' }),
        },
        {
          id: '2',
          type: 'category',
          title: '강아지 간식',
          description: '맛있는 강아지 간식을 찾아보세요',
          icon: '🦴',
          action: () => navigation.navigate('Shop', { category: '강아지 간식' }),
        },
        {
          id: '3',
          type: 'category',
          title: '고양이 사료',
          description: '건강한 고양이 사료를 찾아보세요',
          icon: '🐟',
          action: () => navigation.navigate('Shop', { category: '고양이 사료' }),
        },
        {
          id: '4',
          type: 'category',
          title: '고양이 간식',
          description: '맛있는 고양이 간식을 찾아보세요',
          icon: '🐱',
          action: () => navigation.navigate('Shop', { category: '고양이 간식' }),
        },
        {
          id: '5',
          type: 'category',
        ...
        },
        {
          ...
          type: 'category',
          title: '배변용품',
          description: '편리한 배변용품을 찾아보세요',
          icon: '🚽',
          action: () => navigation.navigate('Shop', { category: '배변용품' }),
        },
        {
          id: '7',
          type: 'category',
          title: '미용 용품',
          description: '필요한 미용 용품을 쇼핑하세요',
          icon: '✂️',
          action: () => navigation.navigate('Shop', { category: '미용 용품' }),
        },
        {
          id: '8',
          type: 'category',
        ...
        },
        {
          ...
          type: 'category',
          title: '외출 용품',
          description: '편리한 외출 용품을 찾아보세요',
          icon: '🎒',
          action: () => navigation.navigate('Shop', { category: '외출 용품' }),
        },
        {
          id: '10',
          type: 'category',
          title: '하우스/침대',
          description: '편안한 하우스와 침대를 쇼핑하세요',
          icon: '🏠',
          action: () => navigation.navigate('Shop', { category: '하우스/침대' }),
        },
      ].filter(item => 
        item.title.toLowerCase().includes(lowerQuery) || 
        item.description.toLowerCase().includes(lowerQuery)
                ...
                <TouchableOpacity
                  ...
                  <View style={modeStyles.modeIconContainer}>
                    {SERVICE_MODE_CONFIG[mode].icon.startsWith('@') ? (
                      <Image
                        source={
                          SERVICE_MODE_CONFIG[mode].icon === '@walker.png' 
