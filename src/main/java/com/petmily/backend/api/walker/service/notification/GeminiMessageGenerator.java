...
public class GeminiMessageGenerator {
    ...
    public String generateWalkStartMessage(WalkerBooking booking, String petName) {
    ...
    public String generateWalkProgressMessage(WalkerBooking booking, List<WalkingTrack> tracks, String petName) {
        if (tracks.isEmpty()) {
    ...
    public String generateWalkCompleteMessage(WalkerBooking booking, List<WalkingTrack> tracks, String petName) {
        if (tracks.isEmpty()) {
